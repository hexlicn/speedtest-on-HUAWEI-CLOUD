...
class Speedtest(object):
    ...
    def get_best_server(self, servers=None):
        ...
        results = {}
        servers = ({'name': 'Johannesburg', 'url': 'http://speedtest.cellc.co.za:8080/speedtest/upload.php',
                    'country': 'South Africa', 'lon': '28.0456', 'cc': 'ZA', 'host': 'speedtest.cellc.co.za:8080',
                    'sponsor': 'Cell C', 'lat': '-26.2044', 'id': '1620', 'd': 0.08521976909151716},
                   {'name': 'Johannesburg', 'url': 'http://speedtest.jhb.mweb.co.za:8080/speedtest/upload.php',
                    'country': 'South Africa', 'lon': '28.0456', 'cc': 'ZA', 'host': 'speedtest.jhb.mweb.co.za:8080',
                    'sponsor': 'MWEB', 'lat': '-26.2044', 'id': '1817', 'd': 0.08521976909151716},
                   {'name': 'Johannesburg', 'url': 'http://spdtest-teraco.afrihost.com:8080/speedtest/upload.php',
                    'country': 'South Africa', 'lon': '28.0456', 'cc': 'ZA', 'host': 'spdtest-teraco.afrihost.com:8080',
                    'sponsor': 'Afrihost', 'lat': '-26.2044', 'id': '12286', 'd': 0.08521976909151716},
                   {'name': 'Johannesburg', 'url': 'http://jnb01.bitco.co.za:8080/speedtester/upload.php',
                    'country': 'South Africa', 'lon': '28.0456', 'cc': 'ZA', 'host': 'jnb01.bitco.co.za:8080',
                    'sponsor': 'BitCo', 'lat': '-26.2044', 'id': '26307', 'd': 0.08521976909151716},
                   {'name': 'Johannesburg', 'url': 'http://speedtest-jhb-01.ecn.co.za:8080/speedtest/upload.php',
                    'country': 'South Africa', 'lon': '28.0456', 'cc': 'ZA', 'host': 'speedtest-jhb-01.ecn.co.za:8080',
                    'sponsor': 'ECN (Pty) Ltd', 'lat': '-26.2044', 'id': '18633', 'd': 0.08521976909151716})
